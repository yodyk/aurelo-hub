      ...
      <Container style={card}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            ...
            team wants you on board. Accept below to join the workspace and start collaborating.
          </Text>
        ...
        <Section style={footerSection}>
          <Text style={footer}>
            Wasn't expecting this? You can safely ignore it — no account will be created.
          </Text>
...
const link = { color: '#5ea1bf', textDecoration: 'none', fontWeight: '600' as const }
