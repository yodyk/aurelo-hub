    ...
    <Body style={main}>
      <Container style={card}>
        ...
        <Section style={content}>
          ...
          <Heading style={h1}>Pick a new password</Heading>
          <Text style={text}>
            We got your request. Click below to choose a new password for your {siteName} workspace. This link will expire shortly, so don't wait too long.
          </Text>
        ...
        <Section style={footerSection}>
          <Text style={footer}>
            Didn't request this? No worries — your password won't change unless you click the link above.
          </Text>
...
const button = { backgroundColor: '#5ea1bf', borderRadius: '8px', padding: '0' }
const buttonLink = { color: '#ffffff', fontSize: '14px', fontWeight: '600' as const, textDecoration: 'none', display: 'inline-block', padding: '14px 32px' }
