...
export function runFinanceFixtures(): FinanceFixtureResult[] {
  ...
  return [
    ...
    { name: 'business use and tax formulas', pass: totals.businessUseExpensesCents === 1740 && totals.taxReserveCents === 2083, expected: [1740, 2083], actual: [totals.businessUseExpensesCents, totals.taxReserveCents] },
