...
export const TASK_STATUSES: TaskStatusConfig[] = [
  ...
  { value: 'needs_edits', label: 'Needs Edits', icon: AlertCircle,  dotClass: 'bg-destructive',         textClass: 'text-destructive',                      bgClass: 'bg-destructive/10',   borderClass: 'border-destructive/30', open: true  },
...
export const STATUS_GROUP_ORDER: TaskStatus[] = [
  'in_progress', 'to_do', 'in_review', 'needs_edits', 'on_hold', 'complete',
];

/** Next-status cycle for click-to-advance (in-row checkbox cycle). */
export const STATUS_CYCLE: TaskStatus[] = [
  'to_do', 'in_progress', 'in_review', 'needs_edits', 'on_hold', 'complete',
];
