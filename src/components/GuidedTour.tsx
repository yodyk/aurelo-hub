...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'See your 6-month revenue trend with gross/net views. The metrics below show your effective rate and time investment.',
    route: '/',
    position: 'bottom',
  },
  {
          ...
          >
            ...
            <div className="px-7 pt-8 pb-7 text-center">
              ...
              <motion.div
                ...
                className="w-14 h-14 rounded-2xl bg-[#3B66F0]/10 flex items-center justify-center mx-auto mb-5"
              >
                <motion.div
                ...
                >
                  <Check className="w-7 h-7 text-[#3B66F0]" strokeWidth={2.5} />
                </motion.div>
              </motion.div>
