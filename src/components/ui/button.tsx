...
const buttonVariants = cva(
  ...
  ].join(" "),
  {
    variants: {
      ...
      size: {
        default: "h-[var(--control)] px-3.5",
        sm: "h-[var(--control-sm)] px-3 text-[12.5px]",
        lg: "h-[var(--control-lg)] px-5 text-[14px]",
        xl: "h-[var(--control-xl)] px-6 text-[14px]",
        icon: "h-[var(--control)] w-[var(--control)] p-0",
      },
    },
