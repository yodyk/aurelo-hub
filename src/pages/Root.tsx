...
import { LayoutDashboard, Users, Clock, TrendingUp, Settings, Timer, Square, Menu, X, LogOut, FileText, Sun, Moon, Lock, PanelLeftClose, PanelLeftOpen, Monitor, ChevronRight, CheckSquare, ReceiptText } from 'lucide-react';
...
const navItems: { to: string; icon: any; label: string; end?: boolean; feature?: FeatureKey; hideUnlessFeature?: boolean; requiresFinancials?: boolean }[] = [
  ...
  { to: '/income-expenses', icon: ReceiptText, label: 'Income & Expenses', requiresFinancials: true },
