          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {priorityLevel !== 'medium' && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px]" style={{ fontWeight: 600, color: priorityCfg.color, background: priorityCfg.bg }}>
                  <Flag className="w-2.5 h-2.5" /> {priorityLevel.charAt(0).toUpperCase() + priorityLevel.slice(1)} Priority
                </span>
              )}
              {riskLevel !== 'low' && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px]" style={{ fontWeight: 600, color: riskCfg.color, background: riskCfg.bg }}>
