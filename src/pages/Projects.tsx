        ...
        <div className="flex flex-col md:flex-row gap-2 md:items-center">
          ...
          <div className="relative w-full md:w-56">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 w-full bg-card border border-border rounded-lg text-[14px] hover:bg-accent/40 transition-all focus:outline-none focus:ring-2 focus:ring-primary/20"
                    ...
                    >
                      ...
                      <td className="px-4 py-4 text-right">
                        ...
                        {project.totalValue > 0 && project.hours > 0 ? (() => {
                          ...
                          const rateColor = effRate < (project.clientRate * 0.5) ? '#c27272' : effRate < project.clientRate ? '#bfa044' : '#2e7d9a';
                          return (
